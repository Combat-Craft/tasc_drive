...
try:
    grammar = LlamaGrammar.from_file(
        "/home/doga/rover_llm/asimov_json_arr.gbnf"
    )  # FIX DIRECTORY
...
if __name__ == "__main__":
    while True:
        ...
        prompt = (
            "Translate the user’s instruction into a command JSON matching "
            "the grammar. Do not change requested direction/speed/duration."
            f"{user_in}\n"
        )
