...
class LlmDriveNode(Node):
    """
    Run an LLM-assisted drive command node.

    The node reads terminal prompts, translates them into JSON commands,
    publishes the JSON for logging/debug, and publishes Twist keepalives.
    """
    ...
    def __init__(self):
        ...
        self.get_logger().info(
            ...
            f"{self.PUBLISH_HZ} Hz (keepalive)"
        )
